...
public:
    ...
    // Series management
    virtual Result<std::shared_ptr<TimeSeries>> create_series(const Labels& labels) = 0;
    virtual Result<std::shared_ptr<TimeSeries>> get_series(const Labels& labels) = 0;
    virtual Result<std::vector<std::shared_ptr<TimeSeries>>> get_all_series() = 0;
