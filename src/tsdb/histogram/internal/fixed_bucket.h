#ifndef TSDB_HISTOGRAM_FIXED_BUCKET_H_
#define TSDB_HISTOGRAM_FIXED_BUCKET_H_
 ...
 * 
 * A histogram with fixed bucket boundaries. Values are assigned to buckets
 * based on their position relative to the bucket boundaries.
 */
...
public:
     ...
     * 
     * @param bounds Vector of bucket boundaries (must be sorted)
     */
...
#endif // TSDB_HISTOGRAM_FIXED_BUCKET_H_ 