...
TEST_F(VerificationDebugTest, WriteAndQuerySingleMetric) {
    ...
    std::vector<std::pair<std::string, std::string>> matchers1;
    matchers1.push_back({"__name__", metric_name});
    ...
    std::vector<std::pair<std::string, std::string>> matchers2;
    matchers2.push_back({"__name__", metric_name});
    matchers2.push_back({"attr0", "val0"});
    ...
    std::vector<std::pair<std::string, std::string>> matchers4;
    matchers4.push_back({"__name__", metric_name});
    matchers4.push_back({"attr0", "val0"});
    matchers4.push_back({"attr1", "val1"});
    matchers4.push_back({"attr2", "val2"});
