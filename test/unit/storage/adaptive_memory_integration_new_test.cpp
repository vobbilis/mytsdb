...
#include "tsdb/storage/memory_optimization/adaptive_memory_integration_new.h"
...
class AdaptiveMemoryIntegrationNewTest : public ::testing::Test {
protected:
    void SetUp() override {
...
TEST_F(AdaptiveMemoryIntegrationNewTest, BasicAllocation) {
...
TEST_F(AdaptiveMemoryIntegrationNewTest, MultipleAllocations) {
...
TEST_F(AdaptiveMemoryIntegrationNewTest, AccessPatternRecording) {
...
TEST_F(AdaptiveMemoryIntegrationNewTest, MemoryStatistics) {
...
TEST_F(AdaptiveMemoryIntegrationNewTest, InvalidOperations) {
...
TEST_F(AdaptiveMemoryIntegrationNewTest, ConcurrentAccess) {
...
TEST_F(AdaptiveMemoryIntegrationNewTest, AlignmentRequirements) {
...
TEST_F(AdaptiveMemoryIntegrationNewTest, LargeAllocation) {
